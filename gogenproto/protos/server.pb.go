...
func (DeviceDataType) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_server_proto_enumTypes[0].Descriptor()
}

func (DeviceDataType) Type() protoreflect.EnumType {
	return &file_protos_server_proto_enumTypes[0]
}
...
func (*InstalledApps_App) Descriptor() ([]byte, []int) {
	return file_protos_server_proto_rawDescGZIP(), []int{2, 0}
}
...
const file_protos_server_proto_rawDesc = "" +
	"\n" +
	"\x13protos/server.proto\x12\x12nightswatch.server\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"W\n" +
...
var file_protos_server_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
